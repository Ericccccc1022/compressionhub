...
class Datasets(Dataset):
    ...
    def __getitem__(self, item):
        ...
        transform = transforms.Compose([
            transforms.RandomResizedCrop(self.image_size),  # this may be a necessary step
...
class Datasets_ImageNet(Dataset):
    # todo: load labels in ImageNet, used for the training of "Transformer21"
    def __init__(self, data_dir, image_size=256):
        self.data_dir = data_dir
        self.image_size = image_size
